                ...
                <form wire:submit.prevent="submitForm" method="POST" class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-light text-gray-500">I accept the <a wire:navigate class="font-medium text-primary-600 hover:underline" href="{{route('terms-conditions')}}">Terms and Conditions</a></label>
                        </div>
                    ...
                    <p class="text-sm font-light text-gray-500">
                        Already have an account? <a wire:navigate href="{{ route('login') }}" class="font-medium text-primary-600 hover:underline">Login here</a>
                    </p>
                </form>
            </div>
        </div>
