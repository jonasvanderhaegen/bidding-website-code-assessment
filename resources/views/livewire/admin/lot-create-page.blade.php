<section class="bg-white">
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        <h2 class="mb-4 text-xl font-bold text-gray-900 ">Create a new lot</h2>
        <form action="#" method="POST" wire:submit.prevent="save">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="w-full">
                    <label for="min_bid_amount" class="block mb-2 text-sm font-medium text-gray-900 ">Minimum bidding amount</label>
                ...
                <div>
                    <label for="item-weight" class="block mb-2 text-sm font-medium text-gray-900 ">Priority</label>
                ...
                <div class="w-full">
                    <label for="brand" class="block mb-2 text-sm font-medium text-gray-900 ">Bidding must start from</label>
                ...
                <div class="w-full">
                    <label for="brand" class="block mb-2 text-sm font-medium text-gray-900 ">Bidding must stop after</label>
                ...
                <div class="sm:col-span-2">
                    <label for="meta_description" class="block mb-2 text-sm font-medium text-gray-900 ">Meta description</label>
