...
<section class="bg-white">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">"BidVibe is exciting and innovative" </h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl ">Our auction house that adds a unique twist to traditional auctions. At the heart of the BidVibe experience is a dynamic online platform where bidders come together to compete for exclusive items and experiences.</p>

        </div>
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img class="rounded-e-full" src="homepage.jpg" alt="mockup">
        </div>
    </div>
</section>
...
<section class="bg-white">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div class="max-w-screen-md mb-8 lg:mb-16">
            ...
            <p class="text-gray-500 sm:text-xl ">
                Whether you are a passionate collector or just looking for a unique bargain, BidVibe offers a lively and engaging environment where bidders can discover their own vibe.
            </p>
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            ...
            <div>
                ...
                <div class="flex mt-8 space-x-6 sm:justify-start sm:mt-0">
                    ...
                    <a target="newtab" href="https://www.instagram.com/vanderhaegenjonas/" class="text-gray-500 hover:text-gray-900 ">
                    ...
                    <a target="newtab" href="https://twitter.com/skylence__" class="text-gray-500 hover:text-gray-900 ">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                    </a>
                    <a target="newtab" href="https://github.com/jonasvanderhaegen" class="text-gray-500 hover:text-gray-900 ">
